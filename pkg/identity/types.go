...
type ContactID = domain.ContactID
type ContactVerificationID = domain.ContactVerificationID
type State = domain.State
type User = domain.User
type UserContact = domain.UserContact
type ContactVerification = domain.ContactVerification
...
type ContactKind = domain.ContactKind
type ContactVerificationStatus = domain.ContactVerificationStatus
type ContactVerificationProvider = domain.ContactVerificationProvider
type ContactVerificationStart = domain.ContactVerificationStart
type ContactVerificationChallenge = domain.ContactVerificationChallenge
type ContactVerificationVerify = domain.ContactVerificationVerify
...
const (
	...
	EventContactVerificationStarted   = domain.EventContactVerificationStarted
	EventContactVerificationSucceeded = domain.EventContactVerificationSucceeded
	EventContactVerificationFailed    = domain.EventContactVerificationFailed
	EventContactBound                 = domain.EventContactBound
	EventContactUnbound               = domain.EventContactUnbound
	...
	ContactKindPhone                  = domain.ContactKindPhone
	ContactKindEmail                  = domain.ContactKindEmail
	ContactVerificationPending        = domain.ContactVerificationPending
	ContactVerificationConsumed       = domain.ContactVerificationConsumed
	ContactVerificationExpired        = domain.ContactVerificationExpired
	ContactVerificationCancelled      = domain.ContactVerificationCancelled
	ContactVerificationFailed         = domain.ContactVerificationFailed
)
...
var (
	...
	ErrInvalidContactKind          = domain.ErrInvalidContactKind
	ErrContactTaken                = domain.ErrContactTaken
	ErrContactNotFound             = domain.ErrContactNotFound
	ErrVerificationNotFound        = domain.ErrVerificationNotFound
	ErrVerificationExpired         = domain.ErrVerificationExpired
	ErrVerificationInvalid         = domain.ErrVerificationInvalid
	ErrVerificationUnavailable     = domain.ErrVerificationUnavailable
	ErrVerificationUnsupported     = domain.ErrVerificationUnsupported
...
var (
	...
	NormalizeContactID             = domain.NormalizeContactID
	NormalizeContactVerificationID = domain.NormalizeContactVerificationID
	ValidateUserID                 = domain.ValidateUserID
	ParseUserID                    = domain.ParseUserID
	ParseContactID                 = domain.ParseContactID
	ParseContactVerificationID     = domain.ParseContactVerificationID
